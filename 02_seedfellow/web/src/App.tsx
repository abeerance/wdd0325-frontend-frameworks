...
export default function App(): ReactNode {
	...
	return (
		...
		//         the card and the footer are two elements side by side.
		//         Wrap both in a fragment so this return gives back one value.
		<div className="mx-auto my-10 max-w-sm rounded-xl border border-slate-200 bg-white p-6">
			...
			<p className="text-sm text-slate-500">Lives in CITY</p>

			{/* Task 3. Give this paragraph an inline style object setting
               color to "#b45309". Remember it needs two sets of braces. */}
			<p className="mt-4 text-sm font-medium">Low stock in your area</p>
